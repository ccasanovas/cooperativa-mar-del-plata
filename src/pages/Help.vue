...
<div class="login-form" style="margin: 5% auto 4%;">
   ...
   <textarea rows="6" cols="50" placeholder="Para que podamos ayudarte, te solicitamos el número de medidor o abonado que figura en tu factura y el motivo por el que no puedes ingresar." required="required" maxlength="250" class="form-control max-margin" 
			...
			const messageObject     =
				{
						...
						'motivo' : messageValue + ' APP Cooperativa de servicios Mar del Plata'
				}
